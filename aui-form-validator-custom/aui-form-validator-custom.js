...
// http://jquery.bassistance.de/validate/
            ...
            A.mix(defaults, {
                ...
                REGEX: {
                    alpha: /^[a-z_]*$/i, //note empty is valid
                    alphanum: /^\w*$/, //note empty is valid
                    digits: /^\d*$/, //note empty is valid
                ...
                RULES: {
                    ...
                    max: function (val, node, ruleValue) {
                        return (!val || Lang.toFloat(val) <= ruleValue); //note empty is valid
                    },
